...
<div className="App mt-3 bg-gray-50">
      <div className="mx-auto p-6 pt-0 sm:max-w-5xl">
        <h1 className="mb-2 text-center text-4xl font-medium">Tailwind CSS</h1>
        <h2 className="border-b-2 border-blue-200 pb-2 text-xl font-bold capitalize text-blue-700">
          Advantages
        </h2>
        <div className="mt-2 sm:flex sm:gap-2">
          <div className="flex flex-col items-center rounded-md border-b-4 border-pink-400 bg-white p-6 text-center">
            ...
            <h3 className="my-2 text-base font-bold">No custom CSS</h3>
            <p className="text-sm">
          ...
          <div className="mt-2 flex flex-col items-center rounded-md border-b-4 border-pink-400 bg-white p-6 text-center sm:mt-0">
            <div className="rounded-full bg-gray-200 p-3">
              <svg
                className="h-12 w-12 fill-current"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="my-2 text-base font-bold">Developer Experience</h3>
            <p className="text-sm">
          ...
          <div className="mt-2 flex flex-col items-center rounded-md border-b-4 border-pink-400 bg-white p-6 text-center sm:mt-0">
            ...
            <h3 className="my-2 text-base text-base font-bold">Mobile Friendly</h3>
            <p className="text-sm">
